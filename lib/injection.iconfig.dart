...
import 'package:DDD_firebase_framework/infrastructure/profiles/profile_repository.dart';
...
import 'package:DDD_firebase_framework/presentation/profile/profile_screen.dart';
...
void $initGetIt(GetIt g, {String environment}) {
  ...
  g.registerLazySingleton<IProfileRepository>(
      () => ProfileRepository(g<Firestore>(), g<FirebaseAuth>()));
  ...
  g.registerLazySingleton<ProfileScreen>(() => ProfileScreen());
